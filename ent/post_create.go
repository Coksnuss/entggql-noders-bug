...
func (pc *PostCreate) SetID(ti types.PostID) *PostCreate {
	pc.mutation.SetID(ti)
	return pc
}

// SetCreatorID sets the "creator" edge to the User entity by ID.
func (pc *PostCreate) SetCreatorID(id types.UserID) *PostCreate {
	pc.mutation.SetCreatorID(id)
	return pc
}

// SetNillableCreatorID sets the "creator" edge to the User entity by ID if the given value is not nil.
func (pc *PostCreate) SetNillableCreatorID(id *types.UserID) *PostCreate {
	if id != nil {
...
func (pc *PostCreate) sqlSave(ctx context.Context) (*Post, error) {
	...
	if _spec.ID.Value != nil {
		if id, ok := _spec.ID.Value.(*types.PostID); ok {
			_node.ID = *id
