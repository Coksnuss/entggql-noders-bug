...
func (uu *UserUpdate) AddPostIDs(ids ...types.PostID) *UserUpdate {
...
func (uu *UserUpdate) RemovePostIDs(ids ...types.PostID) *UserUpdate {
...
// AddPostIDs adds the "posts" edge to the Post entity by IDs.
func (uuo *UserUpdateOne) AddPostIDs(ids ...types.PostID) *UserUpdateOne {
...
// RemovePostIDs removes the "posts" edge to Post entities by IDs.
func (uuo *UserUpdateOne) RemovePostIDs(ids ...types.PostID) *UserUpdateOne {
