...
func (pq *PostQuery) FirstID(ctx context.Context) (id types.PostID, err error) {
...
func (pq *PostQuery) FirstIDX(ctx context.Context) types.PostID {
...
func (pq *PostQuery) OnlyID(ctx context.Context) (id types.PostID, err error) {
	var ids []types.PostID
...
func (pq *PostQuery) OnlyIDX(ctx context.Context) types.PostID {
...
func (pq *PostQuery) IDs(ctx context.Context) ([]types.PostID, error) {
	var ids []types.PostID
...
func (pq *PostQuery) IDsX(ctx context.Context) []types.PostID {
	ids, err := pq.IDs(ctx)
	if err != nil {
		panic(err)
	}
